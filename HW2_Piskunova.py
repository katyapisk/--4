...
#корреляции Спирмена. В итоге для меры pmi корреляция получилась 0.1, что является средним результатом, так как списки почти не совпадают с золотым стандартом.
